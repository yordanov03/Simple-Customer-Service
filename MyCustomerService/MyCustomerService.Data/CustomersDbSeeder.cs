...
namespace MyCustomerService.Data
{
    public class CustomersDbSeeder
    {
        ...
        public async Task SeedAsync(IServiceProvider serviceProvider)
        {
            ...
            {
                var customersDb = serviceScope.ServiceProvider.GetService<CustomerServiceDbContext>();
        ...
        public async Task InsertCustomersSampleData(CustomerServiceDbContext db)
        {
