...
namespace SimpleCustomerService.Data
{
    public class CustomerDbSeeder
    {
        ...
        public CustomerDbSeeder(ILoggerFactory loggerFactory)
        {
        ...
        public async Task SeedAsync(IServiceProvider serviceProvider)
        {
            ...
            {
                var customersDb = serviceScope.ServiceProvider.GetService<SimpleCustomerServiceDbContext>();
        ...
        public async Task InsertCustomersSampleData(SimpleCustomerServiceDbContext db)
        {
            ...
            {
                _Logger.LogError($"Error in {nameof(CustomerDbSeeder)}: " + exp.Message);
                throw;
            }
