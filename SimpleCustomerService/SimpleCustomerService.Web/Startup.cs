...
namespace SimpleCustomerService.Web
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<SimpleCustomerServiceDbContext>(options => {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, CustomerDbSeeder customerDbSeeder)
        {
            ...
            customerDbSeeder.SeedAsync(app.ApplicationServices).Wait();
        }
    }
}
